...
import libsys.forms.FormSearch;
...
public class ActionSearch extends Action {
	...
	public ActionForward execute(
		...
		FormSearch formSearch = (FormSearch) form;
		...
		try {
			...
			Vector books_vector=sRemote.getSimpleSearch(f,MyString.split(k,' '),c);
		...
		forward = mapping.findForward("ActionSearch");
